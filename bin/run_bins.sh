...
CMDS1="cargo run --release --bin univar_opt_bench_multhr -- --repeat=1 --min-size=8 --max-size=8 --prepare-threads=64 --poly-commit-scheme=kzg_offloaded --run-threads=1 --batch-opening-threads=1 | tee -a output_log/univar_opt_bench_run_1_open_8.log "
