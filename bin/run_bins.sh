...
{ echo 'Running: RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=64 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=64 --f="g1*g2 + g3 + g4"; } > output_log/mullin_opt_bench_20_20_run_64_ligero_open_64.log 2>&1
...
{ echo 'Running: RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=64 --poly-commit-scheme=ligero --batch-opening-threads=64 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=64 --poly-commit-scheme=ligero --batch-opening-threads=64 --f="g1*g2 + g3 + g4"; } > output_log/univar_opt_bench_20_20_run_64_ligero_open_64.log 2>&1
