...
# { echo "Running: RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=60" ; RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=60; } > output_log/univar_opt_bench_20_20_run_12_ligero_open_60.log 2>&1
