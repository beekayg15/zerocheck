...
####### multi-linear (ligero) #######
# { echo "Running: cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=1 --poly-commit-scheme=ligero --batch-opening-threads=4"; cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=20 --max-size=20 --prepare-threads=64 --run-threads=1 --poly-commit-scheme=ligero --batch-opening-threads=4; } >> output_log/mullin_opt_bench_1_26_28_run_1_open_4.log 2>&1
