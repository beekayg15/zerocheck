...
# { echo "Running: RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=48"; RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=48; } > output_log/mullin_opt_bench_24_24_run_12_ligero_open_48.log 2>&1

{ echo 'Running: RAYON_NUM_THREADS=200 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=5 --min-size=20 --max-size=20 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=200 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=5 --min-size=20 --max-size=20 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"; } > output_log/mullin_opt_bench_20_20_run_128_ligero_open_200.log 2>&1
...
# { echo "Running: RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero_poseidon --batch-opening-threads=48"; RAYON_NUM_THREADS=64 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=2 --min-size=24 --max-size=24 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero_poseidon --batch-opening-threads=48; } > output_log/mullin_opt_bench_24_24_run_12_ligeroposeidon_open_48.log 2>&1
...
# { echo "Running: RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=60" ; RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero --batch-opening-threads=60; } > output_log/univar_opt_bench_24_24_run_12_ligero_open_60.log 2>&1

{ echo 'Running: RAYON_NUM_THREADS=200 cargo run --release --bin univar_opt_bench_multhr -- --repeat=5 --min-size=20 --max-size=20 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=200 cargo run --release --bin univar_opt_bench_multhr -- --repeat=5 --min-size=20 --max-size=20 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"; } > output_log/univar_opt_bench_20_20_run_128_ligero_open_200.log 2>&1
...
# { echo "Running: RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=8 --max-size=8 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero_poseidon --batch-opening-threads=60" ; RAYON_NUM_THREADS=64 cargo run --release --bin univar_opt_bench_multhr -- --repeat=2 --min-size=24 --max-size=24 --prepare-threads=64 --run-threads=12 --poly-commit-scheme=ligero_poseidon --batch-opening-threads=60; } > output_log/univar_opt_bench_24_24_run_12_ligeroposeidon_open_60.log 2>&1


{ echo 'Running: RAYON_NUM_THREADS=200 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=26 --max-size=26 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=200 cargo run --release --bin mullin_opt_bench_multhr -- --repeat=1 --min-size=26 --max-size=26 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"; } > output_log/mullin_opt_bench_26_26_run_128_ligero_open_200.log 2>&1

{ echo 'Running: RAYON_NUM_THREADS=200 cargo run --release --bin univar_opt_bench_multhr -- --repeat=1 --min-size=26 --max-size=26 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"' ; RAYON_NUM_THREADS=200 cargo run --release --bin univar_opt_bench_multhr -- --repeat=5 --min-size=26 --max-size=26 --prepare-threads=200 --run-threads=128 --poly-commit-scheme=ligero --batch-opening-threads=200 --f="g1*g2 + g3 + g4"; } > output_log/univar_opt_bench_26_26_run_128_ligero_open_200.log 2>&1
